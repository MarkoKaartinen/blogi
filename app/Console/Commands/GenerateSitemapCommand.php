...
class GenerateSitemapCommand extends Command
{
    ...
    public function handle(): void
    {
        ...
        $pages = ["nyt", "tietoa", "pelihaaste", "ai"];
        ...
        foreach ($recipes as $recipe) {
            $recipes_sitemap->add(route("recipe", [$recipe->slug]));
        }
        ...
        foreach ($recipe_categories as $recipe_category) {
            $recipe_categories_sitemap->add(
                route("recipe.category", [$recipe_category->slug]),
            );
        }
        $recipe_categories_sitemap->writeToFile(
            public_path($recipe_categories_sitemap_name),
        );
        ...
        $recipe_tags_sitemap->writeToFile(
            public_path($recipe_tags_sitemap_name),
        );
