...
class RecipeResource extends Resource
{
    ...
    protected static ?string $label = 'Reseptit';

    protected static ?string $modelLabel = 'Resepti';

    protected static ?string $pluralLabel = 'Reseptit';

    protected static ?string $navigationLabel = 'Reseptit';
