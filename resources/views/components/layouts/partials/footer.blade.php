<div class="container mx-auto flex flex-col items-center justify-between pb-6 md:pb-12 gap-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <a class="text-brand-mastodon hover:text-opacity-80" href="https://kaartinen.photos/@marko" rel="me">
        ...
        <div>
            <a href="https://github.com/MarkoKaartinen/blogi" class="text-white hover:text-opacity-80">
        ...
        <div>
            <a href="{{ route('feed') }}" class="text-brand-rss hover:text-opacity-80">
