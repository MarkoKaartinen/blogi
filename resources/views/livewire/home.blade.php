<div>
    <div class="text-left px-6 md:px-0">
        ...
        <div class="pb-6 md:pb-12 flex gap-x-6 gap-y-4 flex-wrap">
            <div>
                <a class="rounded-xl bg-brand-mastodon text-nord-4 inline-flex items-center font-bold tracking-wider duration-300 transition-colors overflow-hidden group" rel="me" href="https://kaartinen.social/@marko" title="Mastodon">
