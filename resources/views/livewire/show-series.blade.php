<div>
    <div class="text-left pb-6 md:pb-12 wrapper">
        ...
        <p class="text-nord-13 text-base">Tällä sivulla on listattuna kaikki sarjan <strong class="lowercase">{{ $series->name }}</strong> artikkelit. Artikkeleita on yhteensä <strong>{{ $series->articles_count }}</strong> kappaletta.</p>
    </div>
