<div>
    <div class="text-left pb-6 md:pb-12 wrapper">
        ...
        <p class="text-nord-13 text-base">Listasin alle kaikki avainsanalla <strong class="bg-nord-13 text-nord-0 text-sm font-bold rounded px-1.5 py-0.5 leading-none lowercase">#{{ $tag->name }}</strong> merkityt artikkelit. Artikkeleita on yhteensä <strong>{{ $tag->articles_count }}</strong> kappaletta.</p>
    </div>
